...
internal sealed class SourceConfiguration : IEntityTypeConfiguration<Source>
{
    ...
    public void Configure(EntityTypeBuilder<Source> builder)
    {
        ...
        builder.Property(s => s.Name).HasMaxLength(FieldLengths.Source.Name).IsRequired();
        builder.Property(s => s.Description).HasMaxLength(FieldLengths.Source.Description);
        builder.Property(s => s.BaseUrl).HasMaxLength(FieldLengths.Source.Url).IsRequired();
        builder.Property(s => s.FeedUrl).HasMaxLength(FieldLengths.Source.Url);
        builder.Property(s => s.LogoUrl).HasMaxLength(FieldLengths.Source.Url);
        builder.Property(s => s.ApiEndpoint).HasMaxLength(FieldLengths.Source.Url);
        ...
        builder.Property(s => s.DefaultLanguageCode).HasMaxLength(FieldLengths.Article.LanguageCode).HasDefaultValue(LanguageDefaults.SourceDefault);
