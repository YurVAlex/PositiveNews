...
public static class DataSeeder
{
    ...
    private static async Task SeedTopicsAsync(AppDbContext context, ILogger logger)
    {
        ...
        var topics = new List<Topic>
        {
            ...
            new() { Name = "Technology",      
                    Slug = "technology,robotics,big tech,artificial intelligence,ai,software,innovations,hardware,internet",       
                    Description = "Tech innovations and digital trends" },
            new() { Name = "Health",           
                    Slug = "health,wellness,medicine",           
                    Description = "Wellness, medicine, and health science" },
            new() { Name = "Science",          
                    Slug = "science,research,energy",          
                    Description = "Scientific discoveries and research" },
            new() { Name = "Environment",      
                    Slug = "environment,climate,ecology",      
                    Description = "Climate, ecology, and conservation" },
            new() { Name = "Space",            
                    Slug = "space,nasa,solar system",            
                    Description = "Astronomy, space exploration, and NASA" },
            new() { Name = "Travel",           
                    Slug = "travel,lifestyle",           
                    Description = "Destinations and adventure" },
            new() { Name = "Animals",          
                    Slug = "animals,wildlife,pets,dogs,cats,birds",          
                    Description = "Wildlife and animal stories" },
            new() { Name = "Inspiring",        
                    Slug = "inspiring,inspirations",        
                    Description = "Uplifting and motivational stories" },
            new() { Name = "Arts & Culture",   
                    Slug = "arts,culture,murals,painting,illustration,illustrations,photography,portraits," +
                           "surreal,anime,paintings,architectural,architecture,craft,creative,sculpture," +
                           "woodworking,artist,books,design",     
                    Description = "Art, music, literature, and culture" },
            new() { Name = "Education",        
                    Slug = "education,learning,teaching,",         
                    Description = "Learning, teaching, and academic breakthroughs" },
            new() { Name = "Business",         
                    Slug = "business,economy,startups,corporate,enterprise",         
                    Description = "Economy, startups, and corporate responsibility" },
            new() { Name = "Sports",           
                    Slug = "sports",           
            ...
            new() { Name = "Software",
                    Slug = "software,cybersecurity,open source,data science",
                    Description = "Gaming news" },
            new() { Name = "Hardware",
                    Slug = "GPU,RTX,GeForce",
                    Description = "New hardware news" },
            new() { Name = "Internet",
                    Slug = "internet,omniverse,cloud",
                    Description = "New hardware news" },
            new() { Name = "Evergreen",
                    Slug = "evergreen",
                    Description = "Content that never goes out of style" },
            new() { Name = "Lifestyle",
                    Slug = "lifestyle,nutrition,homelife,humor,human",
                    Description = "Interests, opinions, behaviours, and behavioural orientations" },
            new() { Name = "Trending",
                    Slug = "trending",
                    Description = "About what's trending" },
            new() { Name = "Design",
                    Slug = "design,style,fashion",
                    Description = "About design, style and fashion" },
            new() { Name = "Politics",
                    Slug = "politics",
                    Description = "Latest Political News" },
            new() { Name = "Social",
                    Slug = "social,community",
                    Description = "Latest Social News" },
            new() { Name = "Nature",
                    Slug = "nature,animals,flowers,earth",
                    Description = "About earth and nature" },
            new() { Name = "Family",
                    Slug = "family,divorce,parenting",
                    Description = "About family relationships" },
            new() { Name = "Psychology",
                    Slug = "psychology,relationships,loneliness,family",
                    Description = "Psychology, relationships and mental health" },
        };
